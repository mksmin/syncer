...
реальный dry run относительно текущего vault. v0.2 читает метаданные сервера и локального vault, но
не скачивает, не обновляет и не удаляет файлы.
...
дерево выбранной папки, сравнит его с vault и покажет число новых, изменённых, пропущенных и
кандидатов в корзину. Это только dry run: файловых операций нет.
